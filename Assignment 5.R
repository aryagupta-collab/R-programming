...
sales_data <- read.csv("C:/Class notes/Data Science/Sem 2/Rajesh sir/Practical book/sales_data.csv")

# Add Revenue column
sales_data$Revenue <- sales_data$Price * sales_data$Quantity

# -------------------------------------------------------------------
# Q.1 Basic ggplot Charts
...
# --------------------------------------------------------------------------------------
# Q.3 Multi-Variable Visualization
...
# ----------------------------------------------------------------------------------------
# Q.4 Bar Chart, Scatter Plot, Histogram Analysis
...
#------------------------------------------------------------------------------------------
# Q.5 Box Plot, Line Chart, Faceted Chart Analysis
